...
## **curso:** Prep Course - Linux Foundation Certified System Administrator (LFCS)  
...
Hubo varias preguntas que no logré resolver o dejé en blanco, lo que indica áreas donde necesito reforzar conocimientos, especialmente en compresión avanzada, redirección específica de salidas y manipulación de archivos con diferentes formatos. Este laboratorio me ayudó a identificar debilidades prácticas, por lo que repetir este tipo de ejercicios será clave para mejorar mi desempeño y consolidar habilidades necesarias para la certificación LFCS.