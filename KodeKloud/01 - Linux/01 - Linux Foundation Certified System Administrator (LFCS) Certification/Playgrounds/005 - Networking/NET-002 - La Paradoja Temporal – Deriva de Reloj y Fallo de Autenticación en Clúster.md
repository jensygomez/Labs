  ...
  ================================================================================
   ...
   ------------------------------------------------------------------------------
    ...
    4. Persistencia y Sincronización (en node03)
       Inicie y habilite el servicio chronyd para que arranque con el sistema.
       Fuerce una sincronización inmediata para corregir la deriva.
    ...
    [ ] chronyd está activo y habilitado en node03                   --> 20%
    [ ] Configuración de chrony apunta a servidor NTP válido         --> 20%
   ...
   🚨 REGLA DE ORO: Use 'timedatectl status' para ver el estado general.
                 ...
                 Fuerce la hora con 'sudo chronyc makestep' si la deriva es muy grande.
  ================================================================================
  TICKET
  EOF
