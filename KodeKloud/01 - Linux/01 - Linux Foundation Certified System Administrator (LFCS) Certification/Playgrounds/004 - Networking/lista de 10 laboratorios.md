...
* **Objetivo**:  Prepararme para aprobar el LFCS, RHCSA, Para Sysadmin Linux Pleno, Devops Enginner y Sysadmin Kubernets.
...
*   **Objetivo**:  Prepararme para aprobar el LFCS, RHCSA, Para Sysadmin Linux Pleno, Devops Enginner y Sysamdin Kubernets. 
