...
# Preparar variables para OpenTofu/Ansible/Tailscale
...
# ==========================================
# ACTUALIZACIÓN DINÁMICA DE /etc/hosts
# ==========================================
...
if os.path.exists(hosts_yml_path):
    ...
    print(f"⚠️ No se encontró {hosts_yml_path}.")
EOF

# ==========================================
# INICIO DE TAILSCALE
# Logs redirigidos a archivo para no ensuciar la terminal
# ==========================================
...
# ==========================================
# VARIABLE DE CONVENIENCIA PARA EL LAB
# ==========================================
