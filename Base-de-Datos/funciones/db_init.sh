...
inicializar_db() {
    ...
    INSERT OR IGNORE INTO propiedades_catalogo (nombre_propiedad, tipo_dato) VALUES ('tiempo_estimado_min', 'numero');
    INSERT OR IGNORE INTO propiedades_catalogo (nombre_propiedad, tipo_dato) VALUES ('tiempo_real_min', 'numero');
    INSERT OR IGNORE INTO propiedades_catalogo (nombre_propiedad, tipo_dato) VALUES ('fecha_inicio', 'fecha');
    INSERT OR IGNORE INTO propiedades_catalogo (nombre_propiedad, tipo_dato) VALUES ('fecha_completado', 'fecha');
