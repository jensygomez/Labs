...
#            │-----------------│           │-----------------│
#            │ eth0 (EDGE)     │           │ eth2 (MGMT)     │
#            │ 10.255.255.2    │           │ 10.255.255.10  │
#            │-----------------│           │-----------------│
#            │ eth1 (SVC)      │           │ Role:           │
#            │ 10.255.255.5    │           │ ✔ Mgmt Bastion │
#            │-----------------│           │ ✔ FW stateful  │
#            │ eth2 (MGMT)     │           │ ✔ SSH / ICMP   │
#            │ 10.255.255.9    │           └─────────────────┘
#            │-----------------│
...
#            └────────┬────────┘
#                     │
#            Core Service Link │ 10.255.255.4/30
#                     │
#              ┌──────┴────────┐
#              │   CORE-SVC    │
#              │---------------│
...
#     │               ACCESS LAYER (PLAN)                │
#     ├───────────────┬────────────┬────────────┬────────┤
#     │ VLAN 10       │ VLAN 20    │ VLAN 30    │ VLAN40 │
#     │ PROD          │ ADMIN      │ SERVICES   │ MON    │
#     │ 10.10.0.0/24  │ 10.20.0.0  │ 10.30.0.0  │10.40.  │
#     └───────────────┴────────────┴────────────┴────────┘
